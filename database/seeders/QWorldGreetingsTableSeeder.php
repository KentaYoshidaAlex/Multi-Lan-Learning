    ...
    public function run(): void
    {
        ...
        DB::table('qWorldGreetings')->insert([
          ...
          [ 
            ...
            'pathBackground' => '/image/picture_english/team_peaceful.jpg', 
            'subLanguage' => '英語', 
          ...
          [ 
            ...
            'pathBackground' => '/image/picture_serbia/serbia_snow_town.jpg', 
            'subLanguage' => 'セルビア語', 
            'jpGreetingWord' => 'ありがとう', 
            'flag' => '/image/Flags/Serbia.svg',
          ],
          [ 
            ...
            'pathBackground' => '/image/vocabraryList22.jpg', 
            'subLanguage' => 'セルビア語', 
            'jpGreetingWord' => '良い一日を', 
            'flag' => '/image/Flags/Serbia.svg',
          ],
          ...
          [ 
            ...
            'pathBackground' => '/image/picture_china/greatWallOfChina2.jpg', 
            'subLanguage' => '中国語', 
            'jpGreetingWord' => 'こんにちは', 
          ...
          [ 
            ...
            'pathBackground' => '/image/picture_china/kyusaikou.jpg', 
            'subLanguage' => '中国語', 
            'jpGreetingWord' => 'ありがとう', 
            'flag' => '/image/Flags/China.svg',
          ],
          ...
          [ 
            'language' => '世界の挨拶',            
            'question' => 'ベトナム語で「こんにちは」は？',
            'answer' => 'シン チャオ', 
            'choice1' => 'マガンダング ハーポン', 
            'choice2' => 'カム オン', 
            'choice3' => 'スラマッパタン', 
            'choice4' => 'シン チャオ', 
            'pathPronunciation' => '../sound/vetnam_word_pronunciation/Xin_chao.mp3', 
            'pathBackground' => '/image/picture_vetnam/train_on_narrow_road.jpg', 
            'subLanguage' => 'ベトナム語', 
            'jpGreetingWord' => 'こんにちは', 
            'flag' => '/image/Flags/Vetnam.gif',
          ],
          [ 
            'language' => '世界の挨拶',            
            'question' => 'ベトナム語で「ありがとう」は？',
            'answer' => 'カム オン', 
            'choice1' => 'サラマットゥ', 
            'choice2' => 'コープン'.'<br>'.'&emsp;'.'&nbsp;'.'+ クラップ(男)/ カー(女)', 
            'choice3' => 'カム オン', 
            'choice4' => 'テレマカシ', 
            'pathPronunciation' => '../sound/vetnam_word_pronunciation/Cam_on.mp3', 
            'pathBackground' => '/image/picture_vetnam/aozai.jpg', 
            'subLanguage' => 'ベトナム語', 
            'jpGreetingWord' => 'ありがとう', 
            'flag' => '/image/Flags/Vetnam.gif',
          ],
          [ 
            'language' => '世界の挨拶',            
            'question' => 'ベトナム語で「良い一日を」は？',
            'answer' => 'チュック モット ガイ'.'<br>'.'&emsp;'.'&nbsp;'.'トット ラン', 
            'choice1' => 'スモガ ハリアンダ'.'<br>'.'&emsp;'.'&nbsp;'.'ムニュナンカン', 
            'choice2' => 'チュック モット ガイ'.'<br>'.'&emsp;'.'&nbsp;'.'トット ラン', 
            'choice3' => 'チョークディーナ'.'<br>'.'&emsp;'.'&nbsp;'.'+ クラップ(男)/ カー(女)', 
            'choice4' => 'インガット', 
            'pathPronunciation' => '../sound/vetnam_word_pronunciation/Chuc_mot_ngay_tot_lanh.mp3', 
            'pathBackground' => '/image/picture_vetnam/goleden_bridge.jpg', 
            'subLanguage' => 'ベトナム語', 
            'jpGreetingWord' => '良い一日を', 
            'flag' => '/image/Flags/Vetnam.gif',
          ],
          ...
          [ 
            ...
            'pathBackground' => '/image/picture_indonesia/bali_island2.jpg', 
            'subLanguage' => 'インドネシア語', 
            'jpGreetingWord' => 'こんにちは', 
          ...
          [ 
            ...
            'pathBackground' => '/image/picture_italy/Amalfi2.jpg', 
            'subLanguage' => 'イタリア語', 
            'jpGreetingWord' => 'こんにちは', 
          ...
          [ 
            ...
            'pathBackground' => '/image/picture_italy/Colosseum_new.jpg', 
            'subLanguage' => 'イタリア語', 
            'jpGreetingWord' => 'ありがとう', 
            'flag' => '/image/Flags/Italy.svg',
          ],
          [ 
            ...
            'pathBackground' => '/image/picture_italy/venice_new.jpg', 
            'subLanguage' => 'イタリア語', 
            'jpGreetingWord' => '良い一日を', 
            'flag' => '/image/Flags/Italy.svg',
          ],
          ...
          [ 
            ...
            'pathBackground' => '/image/picture_germany/Heidelberg_castle2.jpg', 
            'subLanguage' => 'ドイツ語', 
            'jpGreetingWord' => 'ありがとう', 
            'flag' => '/image/Flags/German.svg',
          ],
          ...
          [ 
            'language' => '世界の挨拶',            
            'question' => 'トルコ語で「こんにちは」は？',
            'answer' => 'メルハバ', 
            'choice1' => 'ボンジョルネ', 
            'choice2' => 'メルハバ', 
            'choice3' => 'グーテンターク', 
            'choice4' => 'ボンジュール', 
            'pathPronunciation' => '../sound/turkey_word_pronunciation/Merhaba.mp3', 
          ...
          [ 
            'language' => '世界の挨拶',            
            'question' => 'トルコ語で「ありがとう」は？',
            'answer' => 'テシェキュレール', 
            'choice1' => 'グラシアス', 
            'choice2' => 'メルシー', 
            'choice3' => 'ダンケシェン', 
            'choice4' => 'テシェキュレール', 
            'pathPronunciation' => '../sound/turkey_word_pronunciation/Tesekkurler.mp3', 
          ...
          [ 
            'language' => '世界の挨拶',            
            'question' => 'トルコ語で「良い一日を」は？',
            'answer' => 'イイ ギュンレル', 
            'choice1' => 'ブオナ ジョルナータ', 
            'choice2' => 'アイネン シューネンターク', 
            'choice3' => 'イイ ギュンレル', 
            'choice4' => 'コマンタレヴー', 
            'pathPronunciation' => '../sound/turkey_word_pronunciation/Iyi_gunler.mp3', 
          ...
          [ 
            'language' => '世界の挨拶',            
            'question' => 'アラビア語で「ありがとう」は？',
            'answer' => 'シュクラン', 
            'choice1' => 'シュクメルリ', 
            'choice2' => 'シクンジェマ', 
            'choice3' => 'シュクラン', 
            'choice4' => 'テシェキュレール', 
            'pathPronunciation' => '../sound/arabic_word_pronunciation/thank_you_in_arabic.mp3', 
            'pathBackground' => '/image/picture_arabic/dubai_at_night.jpg', 
            'subLanguage' => 'アラビア語', 
            'jpGreetingWord' => 'ありがとう', 
            'flag' => '/image/Flags/Flag_of_the_African_Union.png',
          ],
          ...
          [ 
            ...
            'pathBackground' => '/image/picture_africa/two_smiling_ladies.jpg', 
            'subLanguage' => 'スワヒリ語', 
            'jpGreetingWord' => 'ありがとう', 
            'flag' => '/image/Flags/Flag_of_the_African_Union.png',
          ],
          [ 
            ...
            'pathBackground' => '/image/picture_africa/zebras.jpg', 
            'subLanguage' => 'スワヒリ語', 
            'jpGreetingWord' => '良い一日を', 
            'flag' => '/image/Flags/Flag_of_the_African_Union.png',
          ],
